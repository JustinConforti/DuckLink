...
$(document).ready(function() {
    ...
    var duckPartner = {
        ...
        setPicture: function() {
            ...
            duckBeak.src = "assets/images/ducksprites/duck_beak.png"; //original size 108 x 93
        ...
        bubbleOut: function() {
            ...
            if(!this.usedBubble){
                game.pause();
                var bubbleAlert = $("<div id='bubbleAlert' title='Whoa! New Power!'>" +
                ...
                "</div>");
                bubbleAlert.hide();
                $("#dungeonContainer").append(bubbleAlert);
                $(function() {
                    $("#bubbleAlert").dialog({
                        buttons: [
                            {
    ...
    function setGame(x, y){
        var startAlert = $("<div id='startAlert' title='The Level Begins!'><p>Your duck partner wants some cake! Use the arrow keys and go to the cake to make him happy!</p></div>");
        startAlert.hide();
        $("#dungeonContainer").append(startAlert);
        $(function() {
            $("#startAlert").dialog({
                buttons: [
                    {
    ...
    function beginGame(x, y){
        ...
        if(game.level === 2){
            ...
            game.pause();
            var powerAlert = $("<div id='powerAlert' title=\"What's this?\"><p>A new power is unlocked! Go to the power sphere for your duck partner to transform!</p></div>");
            powerAlert.hide();
            $("#dungeonContainer").append(powerAlert);
            $(function() {
                $("#powerAlert").dialog({
                    buttons: [
                        {
        ...
        if(game.level >= 3){
            if(game.level===3){
                ...
                "Oh no! Enemies from the land of Poorly Drawn MS Paint Sprites have arrived to stop you from getting the cake! But I hear they can't stand bubbles...</p></div>");
                enemyAlert.hide();
                $("#dungeonContainer").append(enemyAlert);
                $(function() {
                    $("#enemyAlert").dialog({
                        buttons: [
                            {
    ...
    function gotCake() {
            ...
            gotCakeAlert.hide();
            $("#dungeonContainer").append(gotCakeAlert);
            $(function() {
                $("#gotCakeAlert").dialog({
                    buttons: [
                        {
    ...
    function youLose() {
        ...
        $("#dungeonContainer").append(gameOverAlert);
        $(function() {
